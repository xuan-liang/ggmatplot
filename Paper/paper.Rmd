...
head(SnowGR[, 1:11]) %>% 
  ...
  replace_na(list(Jan = ".")) %>% 
  table_styling(caption = 'The first 6 rows and 11 columns of the snowfall data for Grand Rapids, Michigan in the `mosaicData` R pacakge (Prium, Kaplan \\& Horton, 2021).',
                align = "r")
```
...
```{r matplot2, fig.height = 2, fig.cap = "Line plot of the food, service and ambience rating against the overall restaurant rating."}
library(ggmatplot)
