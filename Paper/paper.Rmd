...
table_styling(long_df, col.names = c("Restauant", "Rating type", "Rating"),
              caption = 'Another form for the restaurant rating data in Table \\ref{tab:tab1}. In @Wickham2014-gy, this format is called the "molten" data.')
```


```{r tab3, echo = FALSE}
table_styling(abund_df,
              caption = 'Spider abundance data with environmental covariates. The rows correspond to the site, the first two columns are environmental covariates that measure the soil dry mass and cover moss, and the following five columns shows the abundance of the species.') %>% 
