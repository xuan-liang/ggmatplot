...
wide_df <- tribble(~restaurant, ~person, ~food_rating, ~service_rating, ~ambience_rating, ~overall_rating,
        "R1", "P1", 4, 3, 4, 4,
        "R1", "P2", 4, 5, 4, 4,
        "R1", "P3", 3, 4, 5, 3, 
        "R2", "P1", 2, 4, 4, 3, 
...
```{r tab1, echo = FALSE}
table_styling(wide_df, col.names = c("Restaurant", "Person", "Food",
...
```{r tab2, echo = FALSE}
table_styling(long_df, col.names = c("Restauant", "Person", "Rating type", "Rating"),
