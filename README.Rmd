...
The next example uses the `plot_type = "dotplot"` to visualise the distribution of the data, and also customizes the position of the legend using a `ggplot` theme as well.
